    ...
    <?php if(count($carts) > 0){ ?>
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            <td><img src="<?php h(print(IMAGE_PATH . $cart['image']));?>" class="item_image"></td>
            <td><?php h(print($cart['name'])); ?></td>
            <td><?php h(print(number_format($cart['price']))); ?>円</td>
            <td>
              <form method="post" action="cart_change_amount.php">
                <input type="number" name="amount" value="<?php h(print($cart['amount'])); ?>">
                個
